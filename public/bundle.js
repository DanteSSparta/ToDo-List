...
var Provider = __webpack_require__(23).Provider;
var reducer = __webpack_require__(68);
var AppView = __webpack_require__(70);
    ...
    switch (action.type) {
        ...
        case "ADD_TASK":
            return state.update("tasks", function (tasks) {
                return tasts.push(action.task);
            });
        case "DELETE_TASK":
            return state.update("tasks", function (tasks) {
                return tasks.filterNot(function (item) {
                    return item.text === action.task.text;
                });
            });
        case "CHANGE_STATE_TASK":
            return state.update("tasks", function () {
                var objIndex = tasks.findIndex(function (obj) {
                    return obj.id == action.task.id;
                });
        ...
        case "SAVE_EDIT_TASK":
            return state.update("tasks", function () {
                ...
                tasks[objIndex].edit = false;
                tasks[objIndex].text = action.text;
                return tasks;
            });
            break;
        case "CHANGE_FILTER":
            return state.update("filter", action.filter);
            break;
    }
    return state;
};
...
var React = __webpack_require__(2);
var Connect = __webpack_require__(23).connect;
var actions = __webpack_require__(71);
  ...
  _createClass(AppView, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        null,
        React.createElement(Input, { addTask: this.props.addTask })
      );
    }
  }]);
...
module.exports = connect(mapStateToProps, action)(AppView);
...
var changeStateTask = function changeStateTask(task) {
    return {
...
var saveEditTask = function saveEditTask(task, text) {
    return {
        type: "SAVE_EDIT_TASK",
        task: task,
        text: text
...
var cancelEditTask = function cancelEditTask(task) {
    return {
...
module.exports = { addTask: addTask, deleteTask: deleteTask, changeStateTask: changeStateTask, editTask: editTask, saveEditTask: saveEditTask, cancelEditTask: cancelEditTask, changeFilter: changeFilter };
...
var Input = function (_React$Component) {
    ...
    _createClass(Input, [{
        ...
        key: "onPressKey",
        value: function onPressKey() {
            if (e.keyCode === 13 && this.refs.phoneInput.value !== "") {
                var itemText = this.refs.phoneInput.value;
                this.refs.phoneInput.value = "";
                return this.props.addPhone(itemText);
            }
        ...
        value: function render() {
            return React.createElement(
                "div",
                null,
                React.createElement("input", { ref: "TaskInput", onKeyDown: this.onPressKey.bind(this) }),
                React.createElement(
                    "button",
